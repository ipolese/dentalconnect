...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20231012_dentalconect_d0533ab8a7aa13185345_20231012210308_archive.zip';
        const ARCHIVE_SIZE       = '749986';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'd0533ab-12210308';
        const SECONDARY_PACKAGE_HASH = 'eaf6099-12210308';
        const VERSION            = '1.5.6';
...
<style>.diff-list font { font-weight: bold; }</style>
<style>
