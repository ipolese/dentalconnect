...
function display_filtered_users() {
    ...
    foreach ($users as $user) {
        ...
        if($visivel){
            ...
            $output .= '<a href="' . esc_url(get_permalink(get_page_by_path('editar-cliente'))) . '?user_id=' . $user->ID . '">Editar</a>';
...
add_action('init', 'update_visibility_action');
function update_visibility_action() {
...
add_action('init', 'update_block_action');
function update_block_action() {
...
add_shortcode('list_all_users', 'display_filtered_users');