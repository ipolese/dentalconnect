						...
						?>>
							<span class="sc_igenerator_limits_total"><?php
								...
								echo wp_kses( sprintf(
													...
													sprintf( __( '%s images for all visitors', 'trx_addons' ), '<span class="sc_igenerator_limits_total_value">' . (int)$user_limit['limit'] . '</span>' ),
													! empty( $user_limit['requests'] ) ? ' ' . sprintf( __( 'and up to %s requests from a single visitor', 'trx_addons' ), '<span class="sc_igenerator_limits_total_requests">' . (int)$user_limit['requests'] . '</span>' ) : '',
												),
